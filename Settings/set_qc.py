...
qc_range = {
    ...
    'ML1': {
        ...
        'BIASMEAN': {'default':'None', 'val_type': 'sigma','val_range': [ (  6450, 100) ],            'key_type': 'full', 'pos': True , 'comment': 'average all channel means vertical overscan'},
        ...
        # PSFEx
        # PSF-NOBJ is limited to set_zogy.psf_stars_nmax, so it does not need to be checked anymore
        'PSF-NOBJ': {'default':'None', 'val_type': 'skip',    'val_range': [ (500,2e5), (100,2e5), (10,2e5) ],  'key_type': 'full', 'pos': True , 'comment': 'number of accepted PSF stars'},
        ...
        'T-FTRANS': {'default':'None', 'val_type': 'sigma',   'val_range': [ (0, 0.015)],                       'key_type': 'trans', 'pos': True , 'comment': 'transient fraction: T-NTRANS / NOBJECTS'},
    ...
    'BG3': {
        ...
        #'RDIF-MAX': {'default':'None', 'val_type': 'min_max', 'val_range': {'u': [ (0, 0.250), (0, 0.260), (0, 0.270) ],
        #                                                                    'g': [ (0, 0.160), (0, 0.165), (0, 0.170) ],
        #                                                                    'q': [ (0, 0.100), (0, 0.110), (0, 0.120) ],
