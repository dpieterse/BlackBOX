...
img_reduce_exts = ['_bkg_mini.fits', '_bkg_std_mini.fits', '_red_objmask.fits',
                   '_red_zps.npy', '_red_limmag.fits',
                   '_red.log', '_mask.fits', '_red_hdr.fits', '_red.fits']
cat_extract_exts = ['_psf.fits', '_psfex.cat', '_cat_hdr.fits', '_red_cat.fits']
trans_extract_exts = ['_D.fits', '_Scorr.fits', '_Fpsf.fits',
                      '_trans_limmag.fits', '_trans_hdr.fits', '_trans.fits',
                      #'_sso_predict.fits',
                      '_trans_sso_report.txt', '_trans_sso.fits']
...
asta_model = '{}/model-best.keras'.format(cal_dir)
